...
public class Lemmatizer {
    ...
    private static final Pattern CODE_KEYWORDS_PATTERN = Pattern.compile(
            "\\b(public|private|protected|class|interface|record|enum|def|fn|function|const|let|var|import|package|return|async|await|try|catch|throws|void|int|String|boolean|float|double|val)\\b"
    );
    ...
    private static final Map<String, String> EXPRESSIONS_COMPOSEES = Map.of(
            "en anglais", "traduir",
            "en francais", "traduir",
            "en espagnol", "traduir",
            "revue de code", "code",
    ...
    public static PromptProfile analyser(String rawPrompt) {
        ...
        PromptQualityScorer.Diagnostic qualityDiag = PromptQualityScorer.evaluer(rawPrompt, codeDensity >= 0.15, isCommand, isQuestion);
    ...
    public static boolean detecterCommande(List<String> tokens) {
        ...
        int limit = Math.min(3, tokens.size());
    ...
    public static String detecterLangue(String rawText, List<String> tokens) {
        ...
        Set<String> markersFR = Set.of("le", "la", "les", "un", "une", "des", "dans", "avec", "pour", "est", "qui", "que");
